...
local uiseconomy = Class(Widget, function(self, owner)
    ...
    self.calculateScreenSize = function(x, y)
        local w, h = TheSim:GetScreenSize()
        return Vector3(x * w / _G.RESOLUTION_X / 2, y * h / _G.RESOLUTION_Y / 2,
                       0)
    end
    self.owner = owner
    self.numpage = 1
    ...
    self.mainui.bg =
        self.mainui:AddChild(Image("images/sehud/bg.xml", "bg.tex"))
    self.mainui.bg:SetTint(1, 1, 1, 0.95)
    self.mainui.bg:SetPosition(0, 45, 0)

    self.mainui.bg.title = self.mainui.bg:AddChild(
                               Image("images/sehud/title_food.xml",
                                     "title_food.tex"))
    self.mainui.bg.title:SetPosition(0, 246, 0)

    self.mainui.status = self.mainui:AddChild(Widget("status"))
    self.mainui.status.bg = self.mainui.status:AddChild(
                                Image("images/sehud/status_" .. TUNING.SElan ..
                                          ".xml",
                                      "status_" .. TUNING.SElan .. ".tex"))
    self.mainui.status:SetPosition(410, 25, 0)

    self.mainui.status.coinamount = self.mainui.status:AddChild(
                                        Widget("coinamount"))
    ...
    for i = 1, 6 do
        self.mainui.status.coinamount.num[i] =
            self.mainui.status.coinamount:AddChild(
                Image("images/sehud/bignums/0.xml", "0.tex"))
    ...
    for i = 1, 5 do
        self.mainui.status.level[i] = self.mainui.status:AddChild(
                                          Image("images/sehud/level_dact.xml",
                                                "level_dact.tex"))
        self.mainui.status.level[i]:SetPosition(-130 + (i - 1) * 23, 87, 0)
    end

    self.mainui.status.vipinfo = self.mainui.status:AddChild(
                                     Image("images/sehud/vip0.xml", "vip0.tex"))
    self.mainui.status.vipinfo:SetPosition(0, 66, 0)

    self.mainui.status.swdjinfo = self.mainui.status:AddChild(
                                      Image(
                                          "images/sehud/swdj_" .. TUNING.SElan ..
                                              "1.xml",
                                          "swdj_" .. TUNING.SElan .. "1.tex"))
    self.mainui.status.swdjinfo:SetPosition(0, 66, 0)

    self.mainui.status.exp = self.mainui.status:AddChild(
                                 Image("images/sehud/exp_dact.xml",
                                       "exp_dact.tex"))
    self.mainui.status.exp:SetPosition(-115, 64, 0)
    self.mainui.status.exp:SetClickable(false)

    self.mainui.status.expact = self.mainui.status:AddChild(
                                    Image("images/sehud/exp_act.xml",
                                          "exp_act.tex"))
    self.mainui.status.expact:SetPosition(
        self.mainui.status.exp:GetPosition().x,
        self.mainui.status.exp:GetPosition().y, 0)
    self.mainui.status.expact:SetClickable(false)

    self.mainui.status.expmask = self.mainui.status:AddChild(
                                     Image("images/sehud/expmask.xml",
                                           "expmask.tex"))
    ...
    self.mainui.status.specialitem = self.mainui.status:AddChild(
                                         Widget("specialitem"))
    ...
    self.coinamount:SetHAnchor(_G.ANCHOR_LEFT)
    self.coinamount:SetVAnchor(_G.ANCHOR_BOTTOM)
    self.coinamount:SetPosition(35, 25, 0)
    self.coinamount:SetScale(.8, .8, 1)
    self.coinamount:SetClickable(false)

    self.coinamount.icon = self.coinamount:AddChild(
                               Image("images/sehud/hudcoin.xml", "hudcoin.tex"))
    self.coinamount.icon:SetPosition(-10, 0, 0)
    self.coinamount.icon:SetScale(.2, .2, 1)

    self.coinamount.num = {}
    for i = 1, 6 do
        self.coinamount.num[i] = self.coinamount:AddChild(
                                     Image("images/sehud/bignums/0.xml", "0.tex"))
        self.coinamount.num[i]:SetPosition(i * 17, 0, 0)
    end
    self:displaycoinamount(self.coinamount.num)

    self.mainbutton = self:AddChild(ImageButton("images/sehud/mainbutton.xml",
                                                "mainbutton.tex"))
    self.mainbutton:SetHAnchor(_G.ANCHOR_LEFT)
    self.mainbutton:SetVAnchor(_G.ANCHOR_BOTTOM)
    self.mainbutton:SetPosition(50, 70, 0)
        ...
        if TheInput:IsKeyDown(KEY_CTRL) then
            if self.cooldown then
                if TheInput:IsKeyDown(KEY_SHIFT) then
                    TheNet:Say(STRINGS.LMB .. STRINGS.SIMPLEECONOMY[14] ..
                                   self.owner.seccoin:value() ..
                                   STRINGS.SIMPLEECONOMY[15], true)
                else
                    TheNet:Say(STRINGS.LMB .. STRINGS.SIMPLEECONOMY[16] ..
                                   self.owner.seccoin:value() ..
                                   STRINGS.SIMPLEECONOMY[17], false)
                end
                self.cooldown = false
    ...
    self.mainbutton.new = self.mainbutton:AddChild(
                              Image("images/sehud/new.xml", "new.tex"))
    self.mainbutton.new.middle = 15
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.mainbuttonnewmove == true then
            self.mainbutton.new:MoveTo(Vector3(15,
                                               self.mainbutton.new.middle - 2, 0),
                                       Vector3(15,
                                               self.mainbutton.new.middle + 2, 0),
                                       .25)
    ...
    self.mainui.buttonfood = self.mainui:AddChild(
                                 ImageButton(
                                     "images/sehud/food_act_" .. TUNING.SElan ..
                                         ".xml",
    ...
    self.mainui.buttonfood:SetOnGainFocus(
        function() self.mainui.buttonfood:ScaleTo(1, 1.15, .125) end)
    self.mainui.buttonfood:SetOnLoseFocus(
        function() self.mainui.buttonfood:ScaleTo(1.15, 1, .25) end)
    self.mainui.buttonfood:SetOnClick(function()
        self.numpage = 1
        self:buildbutton("food")
    end)

    self.mainui.buttonfood.uplow = self.mainui.buttonfood:AddChild(
                                       Image("images/sehud/up.xml", "up.tex"))
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.buttonfoodmove == true then
            self.mainui.buttonfood.uplow:MoveTo(Vector3(20, 20 - 2, 0),
                                                Vector3(20, 20 + 2, 0), .25)
    ...
    self.mainui.buttoncloth = self.mainui:AddChild(
                                  ImageButton(
                                      "images/sehud/cloth_dact_" .. TUNING.SElan ..
                                          ".xml",
    ...
    self.mainui.buttoncloth:SetOnGainFocus(
        function() self.mainui.buttoncloth:ScaleTo(1, 1.15, .125) end)
    self.mainui.buttoncloth:SetOnLoseFocus(
        function() self.mainui.buttoncloth:ScaleTo(1.15, 1, .25) end)
    self.mainui.buttoncloth:SetOnClick(function()
        self.numpage = 1
        self:buildbutton("cloth")
    end)

    self.mainui.buttoncloth.uplow = self.mainui.buttoncloth:AddChild(
                                        Image("images/sehud/up.xml", "up.tex"))
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.buttonclothmove == true then
            self.mainui.buttoncloth.uplow:MoveTo(Vector3(20, 20 - 2, 0),
                                                 Vector3(20, 20 + 2, 0), .25)
    ...
    self.mainui.buttonsmithing = self.mainui:AddChild(
                                     ImageButton(
                                         "images/sehud/smithing_dact_" ..
                                             TUNING.SElan .. ".xml",
                                         "smithing_dact_" .. TUNING.SElan ..
                                             ".tex"))
    ...
    self.mainui.buttonsmithing:SetOnGainFocus(
        function() self.mainui.buttonsmithing:ScaleTo(1, 1.15, .125) end)
    self.mainui.buttonsmithing:SetOnLoseFocus(
        function() self.mainui.buttonsmithing:ScaleTo(1.15, 1, .25) end)
    self.mainui.buttonsmithing:SetOnClick(
        function()
            self.numpage = 1
            self:buildbutton("smithing")
        end)

    self.mainui.buttonsmithing.uplow = self.mainui.buttonsmithing:AddChild(
                                           Image("images/sehud/up.xml", "up.tex"))
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.buttonsmithingmove == true then
            self.mainui.buttonsmithing.uplow:MoveTo(Vector3(20, 20 - 2, 0),
                                                    Vector3(20, 20 + 2, 0), .25)
    ...
    self.mainui.buttonresource = self.mainui:AddChild(
                                     ImageButton(
                                         "images/sehud/resource_dact_" ..
                                             TUNING.SElan .. ".xml",
                                         "resource_dact_" .. TUNING.SElan ..
                                             ".tex"))
    ...
    self.mainui.buttonresource:SetOnGainFocus(
        function() self.mainui.buttonresource:ScaleTo(1, 1.15, .125) end)
    self.mainui.buttonresource:SetOnLoseFocus(
        function() self.mainui.buttonresource:ScaleTo(1.15, 1, .25) end)
    self.mainui.buttonresource:SetOnClick(
        function()
            self.numpage = 1
            self:buildbutton("resource")
        end)

    self.mainui.buttonresource.uplow = self.mainui.buttonresource:AddChild(
                                           Image("images/sehud/up.xml", "up.tex"))
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.buttonresourcemove == true then
            self.mainui.buttonresource.uplow:MoveTo(Vector3(20, 20 - 2, 0),
                                                    Vector3(20, 20 + 2, 0), .25)
    ...
    self.mainui.buttonprecious = self.mainui:AddChild(
                                     ImageButton(
                                         "images/sehud/precious_dact_" ..
                                             TUNING.SElan .. ".xml",
                                         "precious_dact_" .. TUNING.SElan ..
                                             ".tex"))
    ...
    self.mainui.buttonprecious:SetOnGainFocus(
        function() self.mainui.buttonprecious:ScaleTo(1, 1.15, .125) end)
    self.mainui.buttonprecious:SetOnLoseFocus(
        function() self.mainui.buttonprecious:ScaleTo(1.15, 1, .25) end)
    self.mainui.buttonprecious:SetOnClick(
        function()
            self.numpage = 1
            self:buildbutton("precious")
        end)

    self.mainui.buttonprecious.new = self.mainui.buttonprecious:AddChild(
                                         Image("images/sehud/new.xml", "new.tex"))
    ...
    self.owner:DoPeriodicTask(.25, function()
        if self.preciousnewmove == true then
            self.mainui.buttonprecious.new:MoveTo(Vector3(20, 20 - 2, 0),
                                                  Vector3(20, 20 + 2, 0), .25)
    ...
    self.mainui.infopage = self.mainui:AddChild(
                               Image(
                                   "images/sehud/infopage_" .. TUNING.SElan ..
                                       ".xml",
                                   "infopage_" .. TUNING.SElan .. ".tex"))
    self.mainui.infopage:SetPosition(0, 0, 0)
    self.mainui.infopage:Hide()

    self.mainui.close = self.mainui:AddChild(
                            ImageButton("images/sehud/close.xml", "close.tex"))
    ...
    self.mainui.close:SetOnGainFocus(function()
        self.mainui.close:ScaleTo(1, 1.15, .125)
    end)
    self.mainui.close:SetOnLoseFocus(function()
        self.mainui.close:ScaleTo(1.15, 1, .25)
    end)
    self.mainui.close:SetOnClick(function() self:onclose() end)

    self.mainui.infobutton = self.mainui:AddChild(
                                 ImageButton("images/sehud/infobutton.xml",
                                             "infobutton.tex"))
    ...
    self.mainui.infobutton:SetOnGainFocus(
        function() self.mainui.infobutton:ScaleTo(1, 1.15, .125) end)
    self.mainui.infobutton:SetOnLoseFocus(
        function() self.mainui.infobutton:ScaleTo(1.15, 1, .25) end)
    self.mainui.infobutton:SetOnClick(function()
        if self.mainui.infopage.shown then
            self.mainui.infobutton:SetTextures("images/sehud/infobutton.xml",
                                               "infobutton.tex")
            self.mainui.infobutton:SetHoverText(STRINGS.SIMPLEECONOMY[3])
            ...
            self.mainui.infobutton:SetTextures("images/sehud/infoback.xml",
                                               "infoback.tex")
    ...
    self.mainui.next = self.mainui:AddChild(
                           ImageButton("images/sehud/next.xml", "next.tex"))
    ...
    self.mainui.next:SetOnGainFocus(function()
        self.mainui.next:ScaleTo(1, 1.15, .125)
    end)
    self.mainui.next:SetOnLoseFocus(function()
        self.mainui.next:ScaleTo(1.15, 1, .25)
    end)
    ...
    self.mainui.back = self.mainui:AddChild(
                           ImageButton("images/sehud/back.xml", "back.tex"))
    ...
    self.mainui.back:SetOnGainFocus(function()
        self.mainui.back:ScaleTo(1, 1.15, .125)
    end)
    self.mainui.back:SetOnLoseFocus(function()
        self.mainui.back:ScaleTo(1.15, 1, .25)
    end)
...
function uiseconomy:OnUpdate(dt)
    ...
    if self.level ~= self.owner.seclevel:value() then
        for i = 1, 5 do
            if self.owner.seclevel:value() >= i then
                self.mainui.status.level[i]:SetTexture(
                    "images/sehud/level_act.xml", "level_act.tex")
            else
                self.mainui.status.level[i]:SetTexture(
                    "images/sehud/level_dact.xml", "level_dact.tex")
            end
        end
        self.mainui.status.swdjinfo:SetTexture(
            "images/sehud/swdj_" .. TUNING.SElan .. self.owner.seclevel:value() ..
                ".xml",
            "swdj_" .. TUNING.SElan .. self.owner.seclevel:value() .. ".tex")
        self.mainui.status.vipinfo:SetTexture(
            "images/sehud/vip" ..
                (self.owner.seclevel:value() * self.owner.secvip:value()) ..
                ".xml", "vip" ..
                (self.owner.seclevel:value() * self.owner.secvip:value()) ..
                ".tex")
    ...
    if self.owner.seclevel:value() >= 5 then
        maxexp = self.owner.seclevel:value() ^ 3 * 1000
    end
    ...
    if self.secpreciouschange ~= self.owner.secpreciouschange:value() then
        if self.title == "precious" then self:buildlist(self.title) end
...
function uiseconomy:uplowchange()
    ...
    for i = 1, #buttonname do
        ...
        if seasont == 1 then buttont.uplow:Hide() end
        if seasont == .5 then
            buttont.uplow:Show()
...
function uiseconomy:buildlist(title)
    ...
    local x = 0
    local y = 0
    for i = 1 + 48 * (self.numpage - 1), math.min(#list,
                                                  48 * (1 + self.numpage - 1)) do
        if math.ceil((i - 48 * (self.numpage - 1)) / 10) ~=
            math.ceil((i - 48 * (self.numpage - 1) - 1) / 10) then
            x = 0
        else
            x = x + 80
        end
        ...
        self.listslot[i] = self.mainui.goodslist:AddChild(
                               ImageButton("images/sehud/slotbg_normal.xml",
                                           "slotbg_normal.tex"))
        if title == "food" then
            self.listslot[i]:SetTextures("images/sehud/slotbg_fresh.xml",
                                         "slotbg_fresh.tex")
        end
        self.listslot[i]:SetPosition(x, y, 0)
        self.listslot[i]:SetNormalScale(1, 1, 1)
        self.listslot[i]:SetFocusScale(1, 1, 1)
        self.listslot[i]:SetOnGainFocus(function()
            self.listslot[i]:ScaleTo(1, 1.15, .125)
        end)
        self.listslot[i]:SetOnLoseFocus(function()
            self.listslot[i]:ScaleTo(1.15, 1, .25)
        end)

        self.listslot[i].im = self.listslot[i]:AddChild(
        ...
        if list[i].name == "blueprint" then
            ...
            self.listslot[i]:SetHoverText(
                STRINGS.NAMES[string.upper(list[i].name)])
        end
        ...
        self.listslot[i].num1:SetTexture(
            "images/sehud/numbers/" .. num1 .. ".xml", num1 .. ".tex")
        self.listslot[i].num2:SetTexture(
            "images/sehud/numbers/" .. num2 .. ".xml", num2 .. ".tex")
        self.listslot[i].num3:SetTexture(
            "images/sehud/numbers/" .. num3 .. ".xml", num3 .. ".tex")
        self.listslot[i].num4:SetTexture(
            "images/sehud/numbers/" .. num4 .. ".xml", num4 .. ".tex")
        ...
        self.listslot[i].OnControl = function(self, control, down)
            if not self:IsEnabled() or not self.focus or self:IsSelected() then
                return
            end
            if control == CONTROL_ACCEPT or control == CONTROL_SECONDARY then
                if down then
                    TheFrontEnd:GetSound()
                        :PlaySound("dontstarve/HUD/click_move")
                    ...
                    if self.down then
                        ...
                        if control == CONTROL_ACCEPT then
                            SendModRPCToServer(MOD_RPC["SimpleEconomy"]["buy"],
                                               list[i].name, list[i].price,
                                               false)
                        elseif control == CONTROL_SECONDARY then
                            SendModRPCToServer(MOD_RPC["SimpleEconomy"]["buy"],
                                               list[i].name, list[i].price, true)
                        end
                        self:StopUpdating()
                    end
                end
...
function uiseconomy:spitembuild(distance)
    ...
    for i = 1, #list do
        ...
        self.spitemslot[i] = self.mainui.status.specialitem:AddChild(
                                 ImageButton("images/sehud/slotbg_special.xml",
                                             "slotbg_special.tex"))
        self.spitemslot[i]:SetPosition(x, 0, 0)
        self.spitemslot[i]:SetNormalScale(1, 1, 1)
        self.spitemslot[i]:SetFocusScale(1, 1, 1)
        self.spitemslot[i]:SetOnGainFocus(
            function() self.spitemslot[i]:ScaleTo(1, 1.15, .125) end)
        self.spitemslot[i]:SetOnLoseFocus(
            function() self.spitemslot[i]:ScaleTo(1.15, 1, .25) end)

        self.spitemslot[i].im = self.spitemslot[i]:AddChild(
                                    Image(
        ...
        self.spitemslot[i]:SetHoverText(
            STRINGS.NAMES[string.upper(list[i].name)])
        ...
        self.spitemslot[i].num1:SetTexture(
            "images/sehud/numbers/" .. num1 .. ".xml", num1 .. ".tex")
        self.spitemslot[i].num2:SetTexture(
            "images/sehud/numbers/" .. num2 .. ".xml", num2 .. ".tex")
        self.spitemslot[i].num3:SetTexture(
            "images/sehud/numbers/" .. num3 .. ".xml", num3 .. ".tex")
        self.spitemslot[i].num4:SetTexture(
            "images/sehud/numbers/" .. num4 .. ".xml", num4 .. ".tex")
        self.spitemslot[i]:SetOnClick(function()
            -- SendModRPCToServer(MOD_RPC["SimpleEconomy"][list[i].name])
            SendModRPCToServer(MOD_RPC["SimpleEconomy"]["buy"], list[i].name,
                               list[i].price)
        end)
    end
end
...
function uiseconomy:buildbutton(title)
    self.mainui.buttonfood:SetTextures(
        "images/sehud/food_dact_" .. TUNING.SElan .. ".xml",
        "food_dact_" .. TUNING.SElan .. ".tex")
    self.mainui.buttoncloth:SetTextures("images/sehud/cloth_dact_" ..
                                            TUNING.SElan .. ".xml",
                                        "cloth_dact_" .. TUNING.SElan .. ".tex")
    self.mainui.buttonsmithing:SetTextures(
        "images/sehud/smithing_dact_" .. TUNING.SElan .. ".xml",
        "smithing_dact_" .. TUNING.SElan .. ".tex")
    self.mainui.buttonresource:SetTextures(
        "images/sehud/resource_dact_" .. TUNING.SElan .. ".xml",
        "resource_dact_" .. TUNING.SElan .. ".tex")
    self.mainui.buttonprecious:SetTextures(
        "images/sehud/precious_dact_" .. TUNING.SElan .. ".xml",
        "precious_dact_" .. TUNING.SElan .. ".tex")
    if title == "food" then
        self.mainui.buttonfood:SetTextures(
            "images/sehud/food_act_" .. TUNING.SElan .. ".xml",
            "food_act_" .. TUNING.SElan .. ".tex")
        self.mainui.bg.title:SetTexture("images/sehud/title_food.xml",
                                        "title_food.tex")
    ...
    if title == "cloth" then
        self.mainui.buttoncloth:SetTextures(
            "images/sehud/cloth_act_" .. TUNING.SElan .. ".xml",
            "cloth_act_" .. TUNING.SElan .. ".tex")
        self.mainui.bg.title:SetTexture("images/sehud/title_cloth.xml",
                                        "title_cloth.tex")
        if self.title == "precious" then
            self.mainui.buttonprecious.new:Hide()
        end
    ...
    if title == "smithing" then
        self.mainui.buttonsmithing:SetTextures(
            "images/sehud/smithing_act_" .. TUNING.SElan .. ".xml",
            "smithing_act_" .. TUNING.SElan .. ".tex")
        self.mainui.bg.title:SetTexture("images/sehud/title_smithing.xml",
                                        "title_smithing.tex")
        if self.title == "precious" then
            self.mainui.buttonprecious.new:Hide()
        end
    ...
    if title == "resource" then
        self.mainui.buttonresource:SetTextures(
            "images/sehud/resource_act_" .. TUNING.SElan .. ".xml",
            "resource_act_" .. TUNING.SElan .. ".tex")
        self.mainui.bg.title:SetTexture("images/sehud/title_resource.xml",
                                        "title_resource.tex")
        if self.title == "precious" then
            self.mainui.buttonprecious.new:Hide()
        end
    ...
    if title == "precious" then
        self.mainui.buttonprecious:SetTextures(
            "images/sehud/precious_act_" .. TUNING.SElan .. ".xml",
            "precious_act_" .. TUNING.SElan .. ".tex")
        self.mainui.bg.title:SetTexture("images/sehud/title_precious.xml",
                                        "title_precious.tex")
        self.mainui.buttonprecious.new:Hide()
...
function uiseconomy:OnControl(control, down)
    if uiseconomy._base.OnControl(self, control, down) then return true end

    if not down then
        if (control == CONTROL_PAUSE or control == CONTROL_CANCEL) and
            self.mainui.shown then self:onclose() end
    end
...
function uiseconomy:displaycoinamount(child)
    ...
    if m >= 100000 then
        ...
        num4 =
            math.floor((m - num1 * 100000 - num2 * 10000 - num3 * 1000) / 100)
        num5 = math.floor(
                   (m - num1 * 100000 - num2 * 10000 - num3 * 1000 - num4 * 100) /
                       10)
        num6 = math.floor(
                   (m - num1 * 100000 - num2 * 10000 - num3 * 1000 - num4 * 100 -
                       num5 * 10) / 1)
        ...
        child[4]:Show()
        child[5]:Show()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 0), 0, 0) end
    end
    if m >= 10000 and m < 100000 then
        ...
        num6 = math.floor((m - num2 * 10000 - num3 * 1000 - num4 * 100 - num5 *
                              10) / 1)
        child[1]:Hide()
        child[2]:Show()
        child[3]:Show()
        child[4]:Show()
        child[5]:Show()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 1), 0, 0) end
    end
    if m >= 1000 and m < 10000 then
        ...
        child[4]:Show()
        child[5]:Show()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 2), 0, 0) end
    end
    if m >= 100 and m < 1000 then
        num1 = 0
        num2 = 0
        ...
        child[4]:Show()
        child[5]:Show()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 3), 0, 0) end
    end
    if m >= 10 and m < 100 then
        num1 = 0
        num2 = 0
        ...
        child[4]:Hide()
        child[5]:Show()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 4), 0, 0) end
    end
    if m < 10 then
        num1 = 0
        num2 = 0
        ...
        child[4]:Hide()
        child[5]:Hide()
        for i = 1, 6 do child[i]:SetPosition(x * (i - 5), 0, 0) end
    end
    child[1]:SetTexture("images/sehud/bignums/" .. num1 .. ".xml",
                        num1 .. ".tex")
    child[2]:SetTexture("images/sehud/bignums/" .. num2 .. ".xml",
                        num2 .. ".tex")
    child[3]:SetTexture("images/sehud/bignums/" .. num3 .. ".xml",
                        num3 .. ".tex")
    child[4]:SetTexture("images/sehud/bignums/" .. num4 .. ".xml",
                        num4 .. ".tex")
    child[5]:SetTexture("images/sehud/bignums/" .. num5 .. ".xml",
                        num5 .. ".tex")
    child[6]:SetTexture("images/sehud/bignums/" .. num6 .. ".xml",
                        num6 .. ".tex")
end
